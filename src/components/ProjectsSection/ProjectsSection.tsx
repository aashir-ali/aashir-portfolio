...
export const ProjectsSection = () => {
  const projects = [
    ...
    {
      id: 2,
      title: "World Immigration Group",
      subtitle: "B2B/B2C platform for immigration consultants (Laravel + React) — 95% Lighthouse, multi-gateway payments, lead automation",
      link: "#",
    ...
    },
    {
      id: 3,
      title: "Jetlocker",
      subtitle: "Smart parcel-locker management platform — automated locker allocation, notifications & REST APIs for logistics partners",
    ...
    {
      id: 4,
      title: "HED KP HR Portal",
      subtitle: "Government HR & administrative system on Laravel serving 100+ institutions — 10,000+ employee records, role-based access, automated HR workflows",
    ...
    <section id="projects" className="w-full max-w-7xl mx-auto px-6 py-24">
      ...
      >
        ...
        <p className="text-muted-foreground text-center md:text-left max-w-2xl text-lg">
          A mix of the automation systems and full-stack platforms I've engineered across CRM, logistics, and enterprise operations.
        </p>
      </motion.div>
