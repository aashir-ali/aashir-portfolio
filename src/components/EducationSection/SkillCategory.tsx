...
export default function ProfessionalProfile() {
  const technicalSkills = [
    ...
    { name: "MySQL / PostgreSQL", level: 85, icon: Database, color: "text-blue-400" },
    { name: "WordPress / WooCommerce", level: 82, icon: Globe, color: "text-indigo-400" },
  ];

  const softSkills = [
    { name: "Problem Solving", icon: Brain, color: "text-purple-400 border-purple-500/30 bg-purple-500/10" },
    { name: "Process Analysis", icon: Workflow, color: "text-sky-400 border-sky-500/30 bg-sky-500/10" },
    { name: "Client Communication", icon: HeartHandshake, color: "text-rose-400 border-rose-500/30 bg-rose-500/10" },
    { name: "Documentation", icon: FileText, color: "text-amber-400 border-amber-500/30 bg-amber-500/10" },
    { name: "Project Management", icon: ClipboardList, color: "text-emerald-400 border-emerald-500/30 bg-emerald-500/10" },
    { name: "Team Collaboration", icon: Users, color: "text-cyan-400 border-cyan-500/30 bg-cyan-500/10" },
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-r from-primary/10 via-purple-500/5 to-transparent border border-primary/20 flex items-start gap-3.5 shadow-sm">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Continuously working with new automation platforms, AI frameworks and integration patterns to ship
