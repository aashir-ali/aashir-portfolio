  ...
  const education = [
    {
      ...
      icon: GraduationCap,
      details: [
        "Advanced study of software architecture, distributed systems and databases",
        "Deepened backend engineering and system-design foundations",
        "Applied coursework directly to real-world web and automation projects"
      ]
    },
    {
      ...
      icon: BookOpen,
      details: [
        "Strong foundation in programming, algorithms, networking and DB management",
        "Graduated with a 3.6 / 4.0 GPA",
        "Covered the full software development lifecycle from requirements to deployment"
      ]
    }
  ];
      ...
      <div>
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            The engineering foundation behind the automation systems and full-stack applications I build.
          </p>
        </motion.div>
