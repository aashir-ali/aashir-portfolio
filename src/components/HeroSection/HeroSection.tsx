        ...
        >
          ...
          >
            <Badge variant="outline" size="lg" className="gap-2.5 py-1.5 px-4 glass-panel border-foreground/10">
              ...
              <span className="text-xs font-medium text-muted-foreground">Available for remote & contract work</span>
            </Badge>
          </motion.div>
          ...
          >
            ...
            <div className="block dark:hidden">
              <span className="bg-gradient-to-r from-violet-600 via-sky-500 via-purple-600 to-indigo-600 bg-clip-text text-transparent font-extrabold text-[clamp(2.6rem,6vw,5rem)] leading-none tracking-tight block pb-2 select-none">
                Aashir Ali Abbas
              </span>
            </div>
              ...
              <div className="p-5 flex flex-col items-center text-center bg-card text-card-foreground flex-1 gap-3">
                ...
                <div className="grid grid-cols-2 gap-2.5 w-full text-left bg-muted/40 p-3 rounded-xl border border-border/50">
                  ...
                  <div>
                    ...
                    <span className="font-bold text-foreground text-xs">Islamabad, PK</span>
                  </div>
                  <div>
                    <span className="text-muted-foreground block text-[9px] uppercase tracking-widest font-bold">Experience</span>
                    <span className="font-bold text-foreground text-xs">5+ Years</span>
                  </div>
                  <div>
